...
/*Роут организующий прием данных со странички аутентификации. Полный путь: /admin/. Внутри осуществляется проверка логина и пароля. 
Если проверка пройдена, в объекте сессии пользователя устанавливается флаг пройденной авторизации и перенаправляем на страницу /admin. 
...
Внутри осуществляется разрушение сессии и перенаправление пользователя на /admin */
