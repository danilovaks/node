...
если авторизован передает управление в другой обработчик, если нет то перенаправляем на путь /admin */
...
Внутри осуществляется проверка логина и пароля c помощью passport. Если проверка пройдена, в функцию обратного вызова придёт объект пользователя (user) и 
перенаправляем на страницу /admin. Если проверка не пройдена возвращаем страницу аутентификации с сообщением об ошибке */
