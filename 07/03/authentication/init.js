...
function initPassport () {
	/* Задаём модулю паспорт по какой стратегии он будет работать и создаём новую локальную стратегию передавая опции и функцию, 
	которая определяет три состояния: ошибка, пользователь не найден с таким логином и паролем и пользователь есть доступ разрешён */
